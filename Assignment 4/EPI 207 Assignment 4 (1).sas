...
Objective: Incorporate feedback to create reproducible data
*****************************************************************/
...
Data g.project2;
	...
	if AC117V2 in (-1, 1) then AC117V2 = 1;   
...
modify chis2020clean;
	xattr set var
			...
			AC117V2		(Values = "1 = Did not use in last 30 days, 2= 1-2 Days, 3= 3-5 Days, 4= 6-9 Days, 5= 10-19 Days, 6= 20-29 Days, 7= 30 Days or more")
	;
quit;
